    ...
    <div className="bg-gradient-to-b from-orange-50 via-white to-blue-50 py-20 px-6 min-h-screen font-sans">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mt-16">
          <button
            className="inline-flex items-center gap-3 bg-gradient-to-r  hover:from-orange-700 hover:to-blue-800 text-white px-10 py-4 rounded-full font-bold text-lg shadow-lg transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-orange-300"
