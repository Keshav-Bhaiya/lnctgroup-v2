...
const LNCTHero = () => {
  ...
  >
    <source src={video} type="video/mp4" />
      ...
      />
      {/* style={{
          backgroundImage: `linear-gradient(rgba(20, 40, 60, 0.6), rgba(20, 40, 60, 0.6)), url('https://lnct.ac.in/wp-content/uploads/2021/04/lnct-slider2-1024x456.jpg')`
        }} */}

<div>
  <div className='w-full h-full relative' >
    <img className='w-full h-screen ' src="https://lnct.ac.in/wp-content/uploads/2021/04/lnct-slider2-1024x456.jpg" alt="" />
