...
import { ArrowRight, ChevronDown, X, Calendar, MapPin, Clock } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-slate-50 to-indigo-100 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute -bottom-40 -left-40 w-96 h-96 bg-indigo-300 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-pulse delay-1000"></div>
      ...
      <div className="container mx-auto px-4 sm:px-6 py-12 flex flex-col lg:flex-row items-center justify-between min-h-screen relative z-10 gap-10 lg:gap-0">
        ...
        >
          <div className="relative">
            ...
            <div className="absolute -top-6 -right-6 w-16 h-16 bg-gradient-to-br from-orange-400 to-blue-400 rounded-full shadow-lg animate-pulse"></div>
            <div className="absolute -bottom-4 -left-4 w-12 h-12 bg-gradient-to-br from-orange-400 to-blue-400 rounded-full shadow-lg animate-bounce"></div>
          </div>
        </div>
      </div>
    </div>
  ...
  const programs = [
    {
      ...
      fullDescription:
        "Our Engineering & Technology programs offer comprehensive education across 15+ specializations including Computer Science, Mechanical, Electrical, Civil, and emerging fields like AI/ML and Robotics. Students gain hands-on experience through industry partnerships, internships, and project-based learning.",
      highlights: [
    ...
    },
    {
      ...
      fullDescription:
        "Our MBBS program provides world-class medical education with extensive clinical training in our 500+ bed hospital. Students learn from experienced faculty and gain practical experience through patient care under supervision.",
      highlights: [
    ...
    },
    {
      ...
      fullDescription:
        "Our BDS program offers comprehensive dental education with hands-on clinical experience in our modern dental clinic. Students learn latest techniques and technologies in dentistry while providing community dental care.",
      highlights: [
    ...
    },
    {
      ...
      intake: "June 2025",
      fullDescription:
        "Our MBA program develops future business leaders through comprehensive curriculum covering all aspects of management. Strong industry connections ensure excellent placement opportunities across various sectors.",
      highlights: [
    ...
    },
    {
      ...
      intake: "July 2025",
      fullDescription:
        "Our integrated law program provides comprehensive legal education with practical training through moot courts, legal aid clinics, and internships with law firms and courts.",
      highlights: [
    ...
    },
    {
      ...
      intake: "July 2025",
      fullDescription:
        "Our B.Arch program combines creativity with technical knowledge, focusing on sustainable design practices. Students work on real projects and gain experience through internships with architectural firms.",
      highlights: [
    ...
    // Additional programs (initially hidden)
    {
      ...
      intake: "June 2025",
      fullDescription:
        "Our science programs offer strong foundation in physics, chemistry, mathematics, and biology with emphasis on research and practical applications. Humanities programs develop critical thinking and communication skills.",
      highlights: [
    ...
    },
    {
      ...
      intake: "July 2025",
      fullDescription:
        "Our agriculture program combines traditional farming knowledge with modern technology. Students gain practical experience on our 50+ acre experimental farm while learning sustainable farming practices.",
      highlights: [
    ...
    },
    {
      ...
      intake: "July 2025",
      fullDescription:
        "Our pharmacy program provides comprehensive education in pharmaceutical sciences with hands-on experience in drug development, quality control, and clinical pharmacy through modern laboratories.",
      highlights: [
    ...
    },
    {
      ...
      intake: "August 2025",
      fullDescription:
        "Our nursing program prepares compassionate healthcare professionals through comprehensive theoretical knowledge and extensive clinical practice in hospitals and community health settings.",
      highlights: [
    ...
    },
    {
      ...
      intake: "August 2025",
      fullDescription:
        "Our physiotherapy program combines theoretical knowledge with hands-on clinical experience, preparing students to become skilled rehabilitation professionals in various healthcare settings.",
      highlights: [
    ...
    },
    {
      ...
      intake: "July 2025",
      fullDescription:
        "Our hotel management program provides comprehensive training in hospitality operations, culinary arts, and service excellence through our on-campus training hotel and industry partnerships.",
      highlights: [
        ...
        <div className="bg-white rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto p-2 sm:p-4">
          ...
          <div className="p-4 sm:p-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                className="flex-1 border-2 border-gray-300 text-gray-700 px-6 py-3 rounded-xl font-medium hover:bg-gray-50 transition-all cursor-pointer text-center"
                href="https://lnct.ac.in/wp-content/uploads/2025/03/LNCT-Brochure.pdf"
              >
                Download Brochure
              </a>
            </div>
  ...
  return (
    <div id="programs-section" className="bg-gradient-to-br from-blue-100 via-orange-50 to-orange-100 min-h-screen py-20">
      <div className="max-w-7xl mx-auto px-2 sm:px-4">
        ...
        >
          <div className="inline-block px-6 py-2 bg-gradient-to-r from-orange-600 to-orange-600 rounded-full text-white text-sm font-medium mb-6">
            ✨ Academic Excellence
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {visiblePrograms.map((program, index) => (
            <div
              key={program.id}
              className={`group relative bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-blue-200 ${
            ...
            >
              {/* Gradient Background */}
              <div
                className={`absolute inset-0 bg-gradient-to-br ${program.bgGradient} opacity-0 group-hover:opacity-10 transition-opacity duration-300`}
              ></div>
              ...
              <div className="relative h-48 overflow-hidden bg-gradient-to-br from-blue-100 to-indigo-100">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div
                    className={`text-6xl transform transition-all duration-300 ${hoveredProgram === program.id ? "scale-105 " : "scale-100"}`}
                  >
                    <img
              ...
              <div className="p-4 sm:p-6 relative z-10">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <div
                    className={`px-3 py-1 bg-gradient-to-r ${program.bgGradient} text-white text-xs rounded-full font-medium`}
                  >
                    {program.stats}
                  </div>
                </div>
                ...
                <div className="flex gap-2">
                  <div
                    ...
                    className="flex-1 group/btn inline-flex items-center justify-center text-blue-700 hover:text-blue-800 font-medium text-sm transition-all duration-200 bg-blue-100 hover:bg-blue-100 px-4 py-2 rounded-lg cursor-pointer"
                  >
                  ...
                  <a
                    className="px-4 py-2 bg-blue-100 text-white text-sm rounded-lg font-medium hover:shadow-lg transition-all cursor-pointer"
                    href={program.apply}
                  >
                    Apply
                  </a>
        ...
        {/* CTA Section */}
        <div
          className={`mt-20 transform transition-all duration-1000 delay-500 ${isVisible ? "translate-y-0 opacity-100" : "translate-y-12 opacity-0"}`}
        >
  ...
  return (
    <div className="font-sans">
      ...
      <div className="fixed bottom-6 right-6 z-20">
        <div className="bg-gradient-to-r from-orange-600 to-orange-700 hover:from-blue-700 hover:to-blue-800 text-white px-5 py-3 rounded-full shadow-xl transition-all duration-300 flex items-center gap-2 text-sm font-semibold">
