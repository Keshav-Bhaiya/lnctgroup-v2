        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              <div>
                <h2 className="text-4xl lg:text-5xl font-bold text-cyan-500 mb-4">
                  LNCT MOBILE EXPERIENCE
                </h2>
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-800 mb-2">Results & Grades</h3>
                    <p className="text-gray-600 text-sm">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button className="bg-black text-white px-6 py-3 rounded-lg flex items-center justify-center space-x-3 hover:bg-gray-800 transition-colors">
          ...
          <div className="mb-16">
            ...
            >
              ...
              <div className="absolute inset-0 opacity-30">
                ...
                <div className="absolute top-1/3 left-1/2 w-2 h-2 bg-orange-400 rounded-full animate-pulse"></div>
                <div className="absolute top-1/2 right-1/4 w-2 h-2 bg-orange-400 rounded-full animate-pulse"></div>
                <div className="absolute bottom-1/3 left-1/3 w-2 h-2 bg-orange-400 rounded-full animate-pulse"></div>
              ...
              <div className="relative z-10 p-8 lg:p-12">
                <div className="grid lg:grid-cols-2 gap-8 items-center">
                  <div className="text-white space-y-6">
                    <h3 className="text-3xl lg:text-4xl font-bold">Global Footprint</h3>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center space-x-4">
                        ...
                        <span className="text-blue-100">Alumni Network</span>
                      </div>
                      <div className="flex items-center space-x-4">
                        <span className="text-3xl lg:text-4xl font-bold text-orange-400">40+</span>
                        <span className="text-blue-100">Countries</span>
                      </div>
                      <div className="flex items-center space-x-4">
                        <span className="text-3xl lg:text-4xl font-bold text-orange-400">500+</span>
                        <span className="text-blue-100">Global Companies</span>
                      </div>
                    </div>
                  </div>
